<?php 
      ...
      //setup the paginator
      $action = (isset($_GET['action'])) ? basename($_GET['action']) : 'patios_walkways.php';
      $limit = (isset($_GET['limit'])) ? $_GET['limit'] : 20;
      $page = (isset($_GET['page'])) ? $_GET['page'] : 1;
      $links = (isset($_GET['links'])) ? $_GET['links'] : 3; 
      $path = ('images/portfolio/Patios and Walkways');
...
?> 
        ...
        <div id="gallery-section">
            <div class="container" ng-controller="imgController">
                <h1><span class="red">PATIOS</span> AND <span class="red">WALKWAYS</span></h1>                
                <div class="row">
